...
\newcommand{\titol}{
	 Trabajo 2 - Linea Indexada
	 }

\newcommand{\titolcap}{Memoria linea indexada}
...
\newcommand{\Data}{Noviembre del 2025}
...
\input{./configuraciones/configura_listings_SCL}
...
%\input{./capitulos/cap_resume}
%\input{./capitulos/cap_introducion}
\input{./capitulos/cap_metodologia}
\input{./capitulos/cap_estructura_tia.tex}
\input{./capitulos/cap_grafcets_1.tex}
\input{./capitulos/cap_grafcets_2.tex}
\input{./capitulos/cap_grafcets_3.tex}
\input{./capitulos/cap_grafcets_4.tex}
\input{./capitulos/cap_grafcets_5.tex}
\input{./capitulos/cap_grafcets_6.tex}
\input{./capitulos/cap_HMI.tex}
\input{./capitulos/cap_resultados.tex}
%\input{./capitulos/cap_errores.tex}
%\input{./capitulos/cap_Conclusiones.tex}
\input{./capitulos/cap_anexos.tex}
