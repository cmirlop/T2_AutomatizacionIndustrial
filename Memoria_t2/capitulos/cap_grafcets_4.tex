\subsection{Grafcet Máquina 5 soporte}

En la siguiente fígura vemos los siguientes elementos:
\begin{itemize}
	\item 3 Cintas
	\item 1 Clamper
	\item 1 Sensor
...
\begin{figure}[H]
	...
	\medskip
	\label{fig:maq2}
	\caption{Maquina 5 de la línea de soportes}
\end{figure}
...
grafcet que hablaremos más adelante (REF), y que nos colocará la pieza en su sitio. Una vez nos diga la 
...
Aqui la alarma que tratamos es que la pieza tarde más de 15 segundos en llegar al sensor
...
En la siguiente figura (REF) observamos la máquina que forman la máquina numero 5 de la línea de vacunas, 
...
El funcionamineto que describe el grafcet (REF) es el siguiente, activamos 
...
y bajarlo, aqui ya soltaremos el gripper y devolveremos el robot a su posición de reposo.
