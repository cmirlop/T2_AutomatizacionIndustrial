...
En la siguiente figura (\ref{graf:principal}), vemos el grafcet principal, el cual se encarga 
...
En la siguietne figura(\ref{graf:paro}) observamos el grafcet que trata el botón del paro, 
