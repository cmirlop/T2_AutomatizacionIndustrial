...
Como vemos en la siguiente figura (\hyperref[fig:maq1]{Máquina 1}), esta máquina esta compuesta por:
\begin{itemize}
...
\begin{itemize}
	\item Si cuando el objeto esta de camino al sensor del final de la cinta, se pone otro objeto al principio de la cinta.
...
Como vemos en el grafcet (\hyperref[graf:Identificador_Tipo]{Grafcet Identificador Tipo}), en esta máquina cuando nos entrega la pieza la máquina anterior, determinamos
3 caminos:
\begin{itemize}
